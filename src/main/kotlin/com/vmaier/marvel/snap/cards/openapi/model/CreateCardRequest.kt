...
data class CreateCardRequest(
    ...
    @field:Schema(description = "Amount of energy cost for playing this card", required = true, minimum = "0", maximum = "10")
    val cost: Int?,

    @field:Schema(description = "Amount of power when played", required = true, minimum = "-20", maximum = "20")
    val power: Int?,

    @field:Schema(description = "Description of the ability the character of the card has. Can be empty.", nullable = true, maxLength = 1024)
    val ability: String?,
